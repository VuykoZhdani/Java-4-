...
public class Compass {
    ...
    public String toCSV() {
        return String.format(String.valueOf(sortArraybyWeight()),gettools(),sortArraybyPrice(),sortArraybyPriceR(),findUsingEnhancedForLoop(),findUsingEnhancedForLoop(),printArray(),sortArraybyWeightR());
    }
}
